...
public:
    ...
    LPCSTR(WINAPI* GetVersion)();
    void    (WINAPI* Command)(HWND hWnd, LPCSTR lpCmd);
    BOOL(WINAPI* GetWindowHandles)(HWND* lphMain, HWND* lphTree, HWND* lphList, HWND* lphView);
    UINT(WINAPI* RegisterCommand)(LPCSTR lpszComment, int nTarget, void (CALLBACK* lpCallback)(HWND, LPARAM));
    UINT(WINAPI* RegisterUICallback)(UINT nID, UINT(CALLBACK* lpCallback)(HWND, LPARAM));
    LPCSTR(WINAPI* GetDataFolder)();
    LPCSTR(WINAPI* GetTempFolder)();
    LPCSTR(WINAPI* GetTempFileName)(LPCSTR lpType);
    LPCSTR(WINAPI* GetCurrentMailBox)();
    void	(WINAPI* SetCurrentMailBox)(LPCSTR lpMailBox);
    LPCSTR(WINAPI* GetCurrentFolder)();
    void	(WINAPI* SetCurrentFolder)(LPCSTR lpFolderID);
    LPCSTR(WINAPI* GetFolderDisplayName)(LPCSTR lpFolderID);
    void	(WINAPI* SetMessageText)(HWND hWnd, LPCSTR lpszMsg);
    LPCSTR(WINAPI* GetCurrentMail)();
    void	(WINAPI* SetCurrentMail)(LPCSTR lpMailID);
    int		(WINAPI* GetNextMail)(int nStart, LPSTR lpszMailID, int nBuf, BOOL bSelected);
    void	(WINAPI* SetSel)(LPCSTR lpMailID, BOOL bSel);
    BOOL(WINAPI* AppendMessage)(LPCSTR lpFolderID, LPCSTR lpszData);
    int		(WINAPI* MoveMessages)(LPCSTR lpFolderID, LPCSTR lpMailIDSet, BOOL bCopy);
    BOOL(WINAPI* MoveSelectedMessages)(LPCSTR lpFolderID, BOOL bCopy);
    DWORD(WINAPI* GetStatus)(LPCSTR lpMailID);
    DWORD(WINAPI* SetStatus)(LPCSTR lpMailID, DWORD dwSet, DWORD dwReset);
    HWND(WINAPI* ComposeMail)(LPCSTR lpURL);
    int		(WINAPI* GetCharSet)(LPCSTR lpMailID, LPSTR lpszCharSet, int nBuf);
    LPSTR(WINAPI* GetSource)(LPCSTR lpMailID);
    void	(WINAPI* SetSource)(LPCSTR lpMailID, LPCSTR lpSource);
    DWORD(WINAPI* GetSize)(LPCSTR lpMailID);
    LPSTR(WINAPI* GetHeader)(LPCSTR lpMailID);
    LPSTR(WINAPI* GetText)(LPSTR lpszMimeType, int nBuf);
    void	(WINAPI* SetText)(int nMode, LPCSTR lpText);
    void	(WINAPI* GetSpecifiedHeader)(LPCSTR lpHeader, LPSTR lpszData, int nBuf);
    void	(WINAPI* SetSpecifiedHeader)(LPCSTR lpHeader, LPCSTR lpszData);
    int		(WINAPI* CompGetCharSet)(HWND hWnd, LPSTR lpszCharSet, int nBuf);
    LPSTR(WINAPI* CompGetSource)(HWND hWnd);
    void	(WINAPI* CompSetSource)(HWND hWnd, LPCSTR lpSource);
    LPSTR(WINAPI* CompGetHeader)(HWND hWnd);
    void	(WINAPI* CompGetSpecifiedHeader)(HWND hWnd, LPCSTR lpHeader, LPSTR lpszData, int nBuf);
    void	(WINAPI* CompSetSpecifiedHeader)(HWND hWnd, LPCSTR lpHeader, LPCSTR lpszData);
    LPSTR(WINAPI* CompGetText)(HWND hWnd, LPSTR lpszMimeType, int nBuf);
    void	(WINAPI* CompSetText)(HWND hWnd, int nMode, LPCSTR lpText);
    void	(WINAPI* CompAttachFile)(HWND hWnd, LPCSTR lpAttachFile, LPCSTR lpMimeType);
    LPVOID(WINAPI* Alloc)(DWORD dwSize);
    LPVOID(WINAPI* ReAlloc)(LPVOID lpVoid, DWORD dwSize);
    void	(WINAPI* Free)(LPVOID lpVoid);
    LPSTR(WINAPI* ISO_2022_JP)(LPCSTR lpSrc, BOOL bEncode);
    LPSTR(WINAPI* ISO_2022_KR)(LPCSTR lpSrc, BOOL bEncode);
    LPSTR(WINAPI* HZ_GB2312)(LPCSTR lpSrc, BOOL bEncode);
    LPSTR(WINAPI* ISO_8859_2)(LPCSTR lpSrc, BOOL bEncode);
    LPSTR(WINAPI* EUC_JP)(LPCSTR lpSrc, BOOL bEncode);
    LPSTR(WINAPI* UTF_7)(LPCSTR lpSrc, BOOL bEncode);
    LPSTR(WINAPI* UTF_8)(LPCSTR lpSrc, BOOL bEncode);
    BOOL(WINAPI* B64Convert)(LPCSTR lpszOutFile, LPCSTR lpszInFile, BOOL bEncode);
    BOOL(WINAPI* QPConvert)(LPCSTR lpszOutFile, LPCSTR lpszInFile, BOOL bEncode);
    LPSTR(WINAPI* MIMEHeader)(LPCSTR lpszIn, LPSTR lpszCharSet, int nBuf, BOOL bEncode);
    LPSTR(WINAPI* SerializeRcpts)(LPCSTR lpAddresses);
    BOOL(WINAPI* Connect)(BOOL bConnect);
    BOOL(WINAPI* NextUnread)(BOOL bBackScroll, BOOL bGoNext);
    void	(WINAPI* ProcessMail)(LPCSTR lpMailID, int nAction, LPCSTR lpParam);
protected:
